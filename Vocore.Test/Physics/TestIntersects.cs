...
namespace Vocore.Test
{
    public class TestIntersects
    {
        ...
        public void TestIntersectsBoxSphere()
        {
            ...
            TestHelper.AssertFalse(!UtilsCollision.BoxSphere(box, sphere));
            TestHelper.AssertFalse(UtilsCollision.BoxSphere(box, sphere2));
        }
        ...
        public void TestIntersectsBox()
        {
            ...
            TestHelper.AssertFalse(UtilsCollision.BoxBox(boxA, boxB));
        ...
        public void TestIntersectsRayBox()
        {
            ...
            TestHelper.AssertFalse(!UtilsCollision.RayBox(ray, box, out RaycastHit hit));
            ...
            TestHelper.AssertFalse(UtilsCollision.RayBox(ray, box, out hit));
            TestHelper.PrintBlue(hit.ToString());
        ...
        public void TestIntersectsRaySphere()
        {
            ...
            TestHelper.AssertFalse(!UtilsCollision.RaySphere(ray, sphere, out RaycastHit hit));
            TestHelper.PrintBlue(hit.ToString());

            sphere = new ShapeSphere(float3.zero, 1f);
            ray = Ray.CreateWithStartAndEnd(new float3(-2, 1.1f, 0), new float3(2, 1.1f, 0));

            TestHelper.AssertFalse(UtilsCollision.RaySphere(ray, sphere, out hit));
            TestHelper.PrintBlue(hit.ToString());
