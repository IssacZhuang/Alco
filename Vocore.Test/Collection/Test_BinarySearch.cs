...
namespace Vocore.Test
{
    public class Test_BinarySearch
    {
        ...
        public void Test_Search(){
            ...
            TestUtility.Assert(index != 4, "binary search failed: expect 4, got "+index);
        }
        ...
        public void Test_SearchFloor(){
            ...
            TestUtility.Assert(index != 2, "binary search failed: expect 2, got "+index);

            index = UtilsAlgorithm.BinarySearchFloor<int>(array, -1);
            TestUtility.Assert(index != -1, "binary search failed: expect -1, got "+index);

            index = UtilsAlgorithm.BinarySearchFloor<int>(array, 13);
            TestUtility.Assert(index != 8, "binary search failed: expect 8, got "+index);
        }
        ...
        public void Test_SearchCeil(){
            ...
            TestUtility.Assert(index != 3, "binary search failed: expect 3, got "+index);
