...
//   - Bindings: _gbufferDepth, _normal, _ssrHistory, _depthPyramid,
//     _ssrHistoryOut
//   - Functions: ReconstructWorldPosition, ApproximateScreenSurfaceRadiance
// The shared cbuffer _data (viewProjection, giParams2, giFrameParams, …) comes
