...
public class DebugStatsRenderer : BaseDebugStatsRenderer
{
    ...
    public DebugStatsRenderer(Input input, View window, float width, float height, RenderingSystem renderingSystem, Shader shaderText, Shader shaderSprite) : base(width, height, renderingSystem, shaderText, shaderSprite)
    {
        _input = input;
        _window = window;
    }
