...
// G-buffer pass shader for normal-mapped PBR materials of the deferred pipeline.
// Writes albedo, world-space normal (from the normal map via TBN) and
// metallic/roughness/ambient-occlusion into three color targets. The vertex layout
// must match Alco.Rendering.VertexPositionNormalTextureTangent exactly.
