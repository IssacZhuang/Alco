...
// Shadow map depth pass shader for cutout/alpha-test materials with tangent
// vertex layout. Same as ShadowDepthTangent.hlsl but samples the albedo texture
// in the pixel shader and discards transparent fragments, so meshes with
// alpha-masked foliage, fences, etc. cast correctly shaped shadows.
// The vertex layout must match Alco.Rendering.VertexPositionNormalTextureTangent exactly.
