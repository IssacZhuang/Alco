...
/// <summary>
/// The GPU buffer that represents an orthographic camera for 2D rendering with adjustable view dimensions.
/// </summary>
public class CameraOrthographicBuffer : BaseCameraBuffer<CameraDataOrthographic>
{
    internal CameraOrthographicBuffer(RenderingSystem renderingSystem, string name) : base(renderingSystem, name)
    {
