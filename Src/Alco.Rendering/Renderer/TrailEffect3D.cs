...
/// <summary>
/// The data-only description of one trail of <see cref="GpuTrailSystem3D"/> — the
/// 3D counterpart of <see cref="TrailEffect2D"/>: geometry behavior (life, spacing,
/// the width envelope), the color gradient and the material reference. Constructible
...
/// trails.
/// </summary>
public sealed class TrailEffect3D
{
    /// <summary>
