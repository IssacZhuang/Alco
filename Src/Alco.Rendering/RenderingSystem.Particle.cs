...
public partial class RenderingSystem
{
    ...
    public ParticleSystem2DCPU CreateParticleSystem2DCPU(Mesh mesh, Material material, IParticleEmitter2D emitter, IParticleSimulator2D? simulator = null)
    {
    ...
    /// <param name="simulator">The simulator to use for the particle system.</param>
    /// <returns>The created particle system.</returns>
    public ParticleSystem2DCPU CreateParticleSystem2DCPU(Material material, IParticleEmitter2D emitter, IParticleSimulator2D? simulator = null)
    {
