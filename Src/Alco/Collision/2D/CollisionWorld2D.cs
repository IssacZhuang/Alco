...
public unsafe class CollisionWorld2D : AutoDisposable
{
    ...
    /// </summary>
    public IBvhBuilder2D? Builder { get; set; }
    ...
    {
        _bvh.BuildTree(_targetColliders.AsSpan(), Builder ?? PairingOrderBvhBuilder2D.Shared);
    }
    ...
    public void CastRay<TCollector>(ref TCollector collector, in Ray2D ray) where TCollector : IRayCastCollector2D
    {
    ...
    private struct ObjectCollectorAdapter<TUserCollector> : IBvhCollisionCastCollector2D
    ...
    private struct RayObjectCollectorAdapter<TUserCollector> : IBvhRayCastCollector2D
        where TUserCollector : IRayCastCollector2D
    {
        private readonly List<object> _targets;
        public TUserCollector UserCollector;
