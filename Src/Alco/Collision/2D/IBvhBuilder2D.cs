...
{
    /// <summary>
    /// A build strategy for <see cref="NativeBvh2D"/>. Implementations arrange the colliders into a binary
    ...
    public interface IBvhBuilder2D
    {
        ...
        void Build(ReadOnlySpan<ColliderRef2D> colliders, Span<BvhNode2D> nodes,
