...
/// </summary>
public abstract class ReusableBatchTask3D : AutoDisposable
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the ReusableBatchTask3D class.
    /// </summary>
    /// <param name="maxConcurrency">The maximum number of concurrent tasks. Defaults to the processor count.</param>
    public ReusableBatchTask3D(int maxConcurrency = 0)
    {
    ...
    /// <summary>
    /// Releases the unmanaged resources used by the ReusableBatchTask3D and optionally releases the managed resources.
    /// </summary>
