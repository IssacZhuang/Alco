...
/// </summary>
public abstract class ReusableBatchTask : AutoDisposable
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the ReusableParallelTask class.
    /// </summary>
    /// <param name="maxConcurrency">The maximum number of concurrent tasks. Defaults to the processor count.</param>
    public ReusableBatchTask(int maxConcurrency = 0)
    {
    ...
    /// <summary>
    /// Releases the unmanaged resources used by the ReusableParallelTask and optionally releases the managed resources.
    /// </summary>
