...
/// </summary>
public abstract class ReusableBatchTask2D : AutoDisposable
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the ReusableBatchTask2D class.
    /// </summary>
    /// <param name="maxConcurrency">The maximum number of concurrent tasks. Defaults to the processor count.</param>
    public ReusableBatchTask2D(int maxConcurrency = 0)
    {
    ...
    /// <summary>
    /// Releases the unmanaged resources used by the ReusableBatchTask2D and optionally releases the managed resources.
    /// </summary>
