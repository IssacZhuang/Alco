...
/// <summary>
/// Represents a fixed-length string with a maximum capacity of 128 characters.
/// This struct provides an efficient way to handle small strings with a predetermined maximum length.
/// </summary>
public unsafe partial struct FixedString128 : IEquatable<FixedString128>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FixedString128"/> struct with the specified string value.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FixedString128"/> struct with the specified character span.
    /// </summary>
    /// <param name="value">The character span to initialize with. If longer than MaxLength, it will be truncated.</param>
    public FixedString128(ReadOnlySpan<char> value)
    {
        Set(value);
    }
    ...
    /// <summary>
    /// Implicitly converts a ReadOnlySpan of characters to a FixedString128.
    /// </summary>
    /// <param name="value">The character span to convert.</param>
    public static implicit operator FixedString128(ReadOnlySpan<char> value)
    {
        return new FixedString128(value);
    }

    /// <summary>
    /// Implicitly converts a FixedString128 to a ReadOnlySpan of characters.
    /// </summary>
    /// <param name="value">The FixedString128 to convert.</param>
    public static implicit operator ReadOnlySpan<char>(FixedString128 value)
    {
        return new ReadOnlySpan<char>(value.Buffer, value.Length);
    }

    /// <summary>
    /// Implicitly converts a FixedString128 to a string.
    /// </summary>
    /// <param name="value">The FixedString128 to convert.</param>
    public static explicit operator string(FixedString128 value)
    {
        return value.ToString();
    }

    /// <summary>
    /// Implicitly converts a string to a FixedString128.
    /// </summary>
    /// <param name="value">The string to convert.</param>
    public static implicit operator FixedString128(string value)
    {
        return new FixedString128(value);
    }
    ...
    {
        if (obj is FixedString128 other)
        {
            return Equals(other);
        }
        return false;
    ...
    /// <summary>
    /// Determines whether this instance equals another FixedString128.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether two FixedString128 instances are equal.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether two FixedString128 instances are not equal.
    /// </summary>
    /// <param name="left">The first string to compare.</param>
    /// <param name="right">The second string to compare.</param>
    ...
    /// <returns>A new FixedString128 that is equivalent to the substring that begins at startIndex.</returns>
    public FixedString128 Substring(int startIndex)
    {
        if (startIndex == 0)
        {
            return this;
    ...
    /// <returns>A new FixedString128 that is equivalent to the substring of length that begins at startIndex.</returns>
    public FixedString128 Substring(int startIndex, int length)
    {
    ...
    /// <returns>A new FixedString128 with all characters converted to lowercase.</returns>
    public FixedString128 ToLower(CultureInfo? culture)
    {
        FixedString128 result = new FixedString128();
    ...
    /// </summary>
    /// <returns>A new FixedString128 with all characters converted to lowercase using the invariant culture.</returns>
    public FixedString128 ToLowerInvariant()
    {
    ...
    /// </summary>
    /// <param name="culture">The culture-specific information for the conversion. If null, uses the current culture.</param>
    /// <returns>A new FixedString128 with all characters converted to uppercase.</returns>
    public FixedString128 ToUpper(CultureInfo? culture)
    ...
    /// </summary>
    /// <returns>A new FixedString128 with all characters converted to uppercase using the invariant culture.</returns>
    public FixedString128 ToUpperInvariant()
    {
    ...
    public FixedString128 Trim(char trimChar)
    {
    ...
    public FixedString128 Trim(params char[] trimChars)
    {
    ...
    public FixedString128 TrimStart()
    {
        return TrimWhiteSpaceHelper(TrimType.Head);
    }
    ...
    public FixedString128 TrimStart(char trimChar)
    {
    ...
    public FixedString128 TrimStart(params char[] trimChars)
    {
        if (trimChars == null || trimChars.Length == 0)
        {
            return TrimWhiteSpaceHelper(TrimType.Head);
    ...
    public FixedString128 TrimEnd(char trimChar)
    {
    ...
    public FixedString128 TrimEnd(params char[] trimChars)
    {
        if (trimChars == null || trimChars.Length == 0)
        {
            return TrimWhiteSpaceHelper(TrimType.Tail);
    ...
    private FixedString128 CreateTrimmedString(int start, int end)
    {
        int len = end - start + 1;
        fixed (char* ptr = Buffer)
        {
            return
                len == Length ? this :
                len == 0 ? new FixedString128() : new FixedString128(new ReadOnlySpan<char>(ptr + start, len));
        }
    }
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a character to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The character to append.</param>
    /// <returns>A new FixedString128 with the character appended.</returns>
    public static FixedString128 operator +(FixedString128 left, char right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    }

    /// <summary>
    /// Creates a new FixedString128 by appending a string to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The string to append.</param>
    /// <returns>A new FixedString128 with the string appended.</returns>
    public static FixedString128 operator +(FixedString128 left, string right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a ReadOnlySpan&lt;char&gt; to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The ReadOnlySpan&lt;char&gt; to append.</param>
    /// <returns>A new FixedString128 with the span appended.</returns>
    public static FixedString128 operator +(FixedString128 left, ReadOnlySpan<char> right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a boolean value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The boolean value to append.</param>
    /// <returns>A new FixedString128 with the boolean appended.</returns>
    public static FixedString128 operator +(FixedString128 left, bool right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a byte value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The byte value to append.</param>
    /// <returns>A new FixedString128 with the byte appended.</returns>
    public static FixedString128 operator +(FixedString128 left, byte right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a signed byte value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The signed byte value to append.</param>
    /// <returns>A new FixedString128 with the signed byte appended.</returns>
    public static FixedString128 operator +(FixedString128 left, sbyte right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a short value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The short value to append.</param>
    /// <returns>A new FixedString128 with the short appended.</returns>
    public static FixedString128 operator +(FixedString128 left, short right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending an unsigned short value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The unsigned short value to append.</param>
    /// <returns>A new FixedString128 with the unsigned short appended.</returns>
    public static FixedString128 operator +(FixedString128 left, ushort right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending an integer value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The integer value to append.</param>
    /// <returns>A new FixedString128 with the integer appended.</returns>
    public static FixedString128 operator +(FixedString128 left, int right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending an unsigned integer value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The unsigned integer value to append.</param>
    /// <returns>A new FixedString128 with the unsigned integer appended.</returns>
    public static FixedString128 operator +(FixedString128 left, uint right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a long value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The long value to append.</param>
    /// <returns>A new FixedString128 with the long appended.</returns>
    public static FixedString128 operator +(FixedString128 left, long right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending an unsigned long value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The unsigned long value to append.</param>
    /// <returns>A new FixedString128 with the unsigned long appended.</returns>
    public static FixedString128 operator +(FixedString128 left, ulong right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a float value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The float value to append.</param>
    /// <returns>A new FixedString128 with the float appended.</returns>
    public static FixedString128 operator +(FixedString128 left, float right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a double value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The double value to append.</param>
    /// <returns>A new FixedString128 with the double appended.</returns>
    public static FixedString128 operator +(FixedString128 left, double right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a decimal value to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The decimal value to append.</param>
    /// <returns>A new FixedString128 with the decimal appended.</returns>
    public static FixedString128 operator +(FixedString128 left, decimal right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a Vector2 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The Vector2 to append.</param>
    /// <returns>A new FixedString128 with the Vector2 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, Vector2 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a Vector3 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The Vector3 to append.</param>
    /// <returns>A new FixedString128 with the Vector3 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, Vector3 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a Vector4 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The Vector4 to append.</param>
    /// <returns>A new FixedString128 with the Vector4 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, Vector4 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a Half2 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The Half2 to append.</param>
    /// <returns>A new FixedString128 with the Half2 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, Half2 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a Half3 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The Half3 to append.</param>
    /// <returns>A new FixedString128 with the Half3 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, Half3 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a Half4 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The Half4 to append.</param>
    /// <returns>A new FixedString128 with the Half4 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, Half4 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending an int2 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The int2 to append.</param>
    /// <returns>A new FixedString128 with the int2 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, int2 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending an int3 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The int3 to append.</param>
    /// <returns>A new FixedString128 with the int3 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, int3 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending an int4 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The int4 to append.</param>
    /// <returns>A new FixedString128 with the int4 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, int4 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a uint2 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The uint2 to append.</param>
    /// <returns>A new FixedString128 with the uint2 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, uint2 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a uint3 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The uint3 to append.</param>
    /// <returns>A new FixedString128 with the uint3 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, uint3 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a uint4 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The uint4 to append.</param>
    /// <returns>A new FixedString128 with the uint4 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, uint4 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a ColorFloat to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The ColorFloat to append.</param>
    /// <returns>A new FixedString128 with the ColorFloat appended.</returns>
    public static FixedString128 operator +(FixedString128 left, ColorFloat right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
    ...
    /// <summary>
    /// Creates a new FixedString128 by appending a Color32 to the current instance.
    /// </summary>
    /// <param name="left">The FixedString128 to append to.</param>
    /// <param name="right">The Color32 to append.</param>
    /// <returns>A new FixedString128 with the Color32 appended.</returns>
    public static FixedString128 operator +(FixedString128 left, Color32 right)
    {
        FixedString128 result = left;
        result.Append(right);
        return result;
