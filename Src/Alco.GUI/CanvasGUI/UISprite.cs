...
public class UISprite : UINode
{
    ...
    protected override void OnUpdateRenderData(Canvas canvas, float delta)
    {
        if (ImageType == ImageType.Sliced && Texture != null)
        {
            ...
            UtilsMesh.Populate9SliceMeshData(Vertices.AsSpan(16), Indices.AsSpan(54), new Vector2(Texture.Width, Texture.Height), Size, Texture.SlicePadding);
        }
    }
    ...
    protected override void OnUpdate(Canvas canvas, float delta)
    {
        ...
        if (ImageType == ImageType.Sliced && Texture != null)
        {
            ...
            canvas.DrawSpriteWithCustomMesh(Vertices.AsSpan(16), Indices.AsSpan(54), Texture, transform.Matrix, UvRect, Color);
            return;
        }
