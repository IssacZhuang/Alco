...
namespace Alco.Test
{
    public class TestIntersects
    {
        ...
        {
            ShapeBox3D box = new ShapeBox3D(new Vector3(2, 0, 0), new Vector3(1, 1, 1), math.quaternion(math.radians(new Vector3(45, 45, 0))));
        ...
        public void TestIntersectsBox()
        {
            ...
            Quaternion rotX90 = math.quaternion(math.radians(new Vector3(90, 0, 0)));
            ...
            boxA = new ShapeBox3D(Vector3.Zero, new Vector3(0.99f), math.quaternion(math.radians(new Vector3(45, 0, 0))));
            boxB = new ShapeBox3D(new Vector3(1, 0, 0), new Vector3(0.99f), Quaternion.Identity);

            Assert.IsFalse(UtilsCollision3D.BoxBox(boxA, boxB));

            boxA = new ShapeBox3D(Vector3.Zero, new Vector3(0.99f), math.quaternion(math.radians(new Vector3(0, 45, 0))));
            boxB = new ShapeBox3D(new Vector3(1, 0, 0), new Vector3(0.99f), Quaternion.Identity);

            Assert.IsTrue(UtilsCollision3D.BoxBox(boxA, boxB));

            boxA = new ShapeBox3D(new Vector3(8, 0.2f, 0f), new Vector3(1f), math.quaternion(math.radians(new Vector3(45))));
            boxB = new ShapeBox3D(new Vector3(9.1f, 0.9f, 0f), new Vector3(1f), math.quaternion(math.radians(new Vector3(45))));

            Assert.IsTrue(UtilsCollision3D.BoxBox(boxA, boxB));

            boxA = new ShapeBox3D(new Vector3(8, 4, 0f), new Vector3(1f), math.quaternion(math.radians(new Vector3(45f))));
            boxB = new ShapeBox3D(new Vector3(9.1f, 4.9f, 0f), new Vector3(1f), math.quaternion(math.radians(new Vector3(45f))));

            Assert.IsFalse(UtilsCollision3D.BoxBox(boxA, boxB));

            boxA = new ShapeBox3D(new Vector3(8, 5, 7f), new Vector3(1f), Quaternion.Identity);
            boxB = new ShapeBox3D(new Vector3(9.1f, 5.9f, 7f), new Vector3(1f), math.quaternion(math.radians(new Vector3(45f))));

            Assert.IsTrue(UtilsCollision3D.BoxBox(boxA, boxB));

            boxA = new ShapeBox3D(new Vector3(8, 0.4f, 0f), new Vector3(1f), math.quaternion(math.radians(new Vector3(45))));
            boxB = new ShapeBox3D(new Vector3(9.1f, 0.9f, 0f), new Vector3(1f), Quaternion.Identity);

            Assert.IsTrue(UtilsCollision3D.BoxBox(boxA, boxB));

            boxA = new ShapeBox3D(Vector3.Zero, new Vector3(1f), math.quaternion(math.radians(new Vector3(45f))));
            boxB = new ShapeBox3D(new Vector3(5f, 5f, 0f), new Vector3(1f), math.quaternion(math.radians(new Vector3(45f))));
            ...
            boxA = new ShapeBox3D(new Vector3(8, 5, 7f), new Vector3(1f), Quaternion.Identity);
            boxB = new ShapeBox3D(new Vector3(9.1f, 5, 7), new Vector3(1f), math.quaternion(math.radians(new Vector3(1f))));
        ...
        public void TestIntersectsRayBox()
        {
            ...
            box = new ShapeBox3D(new Vector3(0, 0, 0), new Vector3(1f), math.quaternion(new Vector3(0, 0, math.radians(135f))));
        ...
        public void TestIntersectsPointBox()
        {
            ...
            box = new ShapeBox3D(Vector3.Zero, new Vector3(1f), math.quaternion(math.radians(new Vector3(0, 0, 45))));
