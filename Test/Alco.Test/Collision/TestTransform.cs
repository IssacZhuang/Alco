...
namespace Alco.Test
{
    public class TestTransform
    {
        ...
        {
            ShapeBox3D box = new ShapeBox3D(new Vector3(0, 0, 0), new Vector3(1, 1, 1), math.quaternion(math.radians(new Vector3(0, 0, 0))));
            Transform3D transform = new Transform3D(math.quaternion(math.radians(new Vector3(45, 0, 0))), new Vector3(0, 0, 0));
