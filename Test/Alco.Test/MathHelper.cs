...
namespace System.Numerics
{
    static class MathHelper
    {
        ...
        public static bool Equal(Quaternion a, Quaternion b, float epsilon = 1e-5f)
        {
            return Equal(a.X, b.X, epsilon) && Equal(a.Y, b.Y, epsilon) && Equal(a.Z, b.Z, epsilon) && Equal(a.W, b.W, epsilon);
        }

        public static bool EqualRotation(Quaternion a, Quaternion b, float epsilon = 1e-5f)
        {
            return Equal(a, b, epsilon) || Equal(a, -b, epsilon);
        }
    }
}
